...
export const createBookmarkPending = createAction<Action>(
  "CREATE_BOOKMARK_PENDING"
);
export const createBookmarkSuccess = createAction<Action>(
  "CREATE_BOOKMARK_SUCCESS"
);
export const createBookmarkError = createAction<Action>(
  "CREATE_BOOKMARK_ERROR"
);

// updateBookmark
export const updateBookmark = createAction<Action>("UPDATE_BOOKMARK");
export const updateBookmarkPending = createAction<Action>(
  "UPDATE_BOOKMARK_PENDING"
);
export const updateBookmarkSuccess = createAction<Action>(
  "UPDATE_BOOKMARK_SUCCESS"
);
export const updateBookmarkError = createAction<Action>(
  "UPDATE_BOOKMARK_ERROR"
);

// deleteBookmark
export const deleteBookmark = createAction<Action>("DELETE_BOOKMARK");
export const deleteBookmarkPending = createAction<Action>(
  "DELETE_BOOKMARK_PENDING"
);
export const deleteBookmarkSuccess = createAction<Action>(
  "DELETE_BOOKMARK_SUCCESS"
);
export const deleteBookmarkError = createAction<Action>(
...
//
export const importLocalBookmarks = createAction<Action>(
  "IMPORT_LOCAL_BOOKMARKS"
);
